resource "azurerm_resource_group" "container_env" {
  name     = "rg-cae-aios-dev-eastus"
  location = var.location
}

resource "azurerm_resource_group" "keyvault" {
  name     = "rg-kv-aios-dev-eastus"
  location = var.location
}

resource "azurerm_resource_group" "openai" {
  name     = "rg-openai-aios-dev-eastus"
  location = var.location
}

resource "azurerm_resource_group" "email_communication" {
  name     = "rg-ecs-aios-dev-eastus"
  location = var.location
}

resource "azurerm_resource_group" "communication" {
  name     = "rg-comms-aios-dev-eastus"
  location = var.location
}

resource "azurerm_resource_group" "database" {
  name     = "rg-psql-aios-dev-eastus"
  location = var.location
}

resource "azurerm_resource_group" "storage" {
  name     = "rg-st-aios-dev-eastus"
  location = var.location
}
